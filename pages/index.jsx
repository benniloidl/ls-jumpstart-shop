...
export async function getStaticProps() {
    // let pageEntries = await getEntriesByContentType("landingPage", "home-page");
    
    // fetch pageEntries from serverless function
    let pageEntries = await fetch(process.env['HOST'] + "/.netlify/functions/landingPage?slug=home-page")
        .then(res => res.json());
